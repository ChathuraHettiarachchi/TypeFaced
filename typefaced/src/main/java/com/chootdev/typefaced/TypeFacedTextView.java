...
public class TypeFacedTextView extends TextView{
    ...
    public TypeFacedTextView(Context _context, AttributeSet attrs, int defStyle) {
    ...
    public TypeFacedTextView(Context _context, AttributeSet attrs) {
    ...
    public TypeFacedTextView(Context _context) {
        super(_context);
        context = _context;
        try {
            init(null);
    ...
    private void init(AttributeSet attrs) throws TypeFacedException{
        if (attrs!=null) {
            ...
            String fontName = a.getString(R.styleable.TypeFacedTextView_textView_font);
            if (fontName!=null) {
                try {
                    Typeface myTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/" + fontName);
                    setTypeface(myTypeface);
                } catch (Exception e){
                    throw new TypeFacedException("Font not found exception");
                }
            }
            a.recycle();
        }
